...
const items = [
	{ name: 'This item violates Sella.me ToS', value: '1' },
			...
			<div className='flex justify-between gap-14 max-md:flex-col max-md:gap-8'>
				<div className='p-4 flex flex-col rounded-[1rem] border border-secondary bg-white/[.02] shadow-sm'>
					...
					<div className='w-full flex flex-col gap-4 p-4'>
						...
						<p className='text-black-40'>This item is advertised as CBD hemp but actually contains a large amount of THC
							which makes it illegal in majority of countries and as a result, prohibited by Sella ToS.</p>

						<Button className='w-full mt-4 gap-3 items-center' colorPalette='gray' size='lg'>
							Open Link
							<Icons.LinkExternal/>
						</Button>
					</div>
					...
					>
						{() => (
							<>
								...
								<Link href={''}>
									<Button type='submit' variant='solid'>Vote</Button>
								</Link>
							</>
						)}
					</Form>
