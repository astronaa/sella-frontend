		...
		<div className="flex flex-col gap-6">
			<div className="flex flex-col lg:flex-row gap-6 lg:gap-0 lg:justify-between items-start lg:items-end">
				<div className="flex flex-col gap-2">
					<div className="text-[2.625rem]/[2.8875rem] lg:text-[2rem]/[2.2rem] font-semibold">
						Buyers Reviews
					</div>
			...
			{reviews.map((review, index) => (
				<div className="flex flex-col px-4 py-6 gap-6 rounded-[1.25rem] border border-white/[.04]" key={index}>
