			...
			<Dialog.Positioner>
				<Dialog.Content className="w-[34.375rem]">
					...
					<Dialog.ContentHeading>
						...
						<Dialog.Description>
              Keep the storefront description catchy and concise. Remember,
              these settings can be changed later through your Seller Dashboard.
						</Dialog.Description>
					</Dialog.ContentHeading>

					<CreateForm id={formId} onActionFulfilled={onActionFulfilled} />
