...
export function SetupTwoFaDialog({ onActionFulfilled, cancelButton, open, ...props }: SetupTwoFaDialogProps) {
	...
	return (
		<>
			<VerifyEmailDialog
				{...props}
				email={email} open={isVerifyEmailDialogOpened}
									...
									<>
										...
										<Dialog.ContentFooter>
											...
											<Button
												...
												disabled={!valid || (isTelegramAuthorized && !values.email?.length)}
											>
												Continue
											</Button>
										</Dialog.ContentFooter>
