...
const styles = tv(
	{
		...
		slots: {
			...
			contentFooter:
        "flex gap-[1rem] w-full [&>*]:w-full max-md:flex-col-reverse",
		...
		variants: {
			size: {
				default: {
					...
					content:
            "p-[3.125rem] rounded-[1.25rem] w-[28.125rem] gap-[3.125rem]",
...
const BaseCloseButton = forwardRef<HTMLButtonElement, HTMLArkProps<"button">>(
	(props, ref) => (
...
// Base dialog props interface for consistent typing across components
export type BaseDialogProps = ComponentProps<typeof Dialog.Root>;
