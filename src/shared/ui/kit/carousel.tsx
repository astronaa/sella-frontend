		...
		variants: {
			size: {
				...
				md: {
					...
					viewport: "carousel__viewport--size_md",
					itemGroup: "carousel__itemGroup--size_md",
					item: "w-full h-[298px] lg:h-[434px] border border-white-04 p-0 lg:p-2 rounded-[20px]",
					nextTrigger: "hidden",
					prevTrigger: "hidden",
					indicatorGroup: "w-full flex items-center justify-between",
					// indicator: "w-[73.2px] h-[55px] lg:w-[145.6px] lg:h-[80px] border-none bg-transparent rounded-[12px] lg:rounded-[16px]",
					indicator: "w-[calc(20%-6px)] h-[55px] lg:h-[80px] border-none bg-transparent rounded-[12px] lg:rounded-[16px]",
					control: "bg-transparent w-full h-12 lg:h-20 relative mt-6",
				},
			},
		},
	},
